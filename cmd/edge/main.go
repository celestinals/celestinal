...
import (
	...
	"github.com/celestinals/celestinal/internal/edge"
...
//
// This is the celestinal edge application, it will automatically connect to
...
//
//	make run.edge // start celestinal edge
...
func main() {
	...
	app := cestcore.Build(edge.New, cestconf.Default)
