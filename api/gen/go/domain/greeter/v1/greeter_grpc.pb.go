...
const (
	GreeterDomainService_SayHello_FullMethodName = "/tickex.domain.greeter.v1.GreeterDomainService/SayHello"
)
...
var GreeterDomainService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "tickex.domain.greeter.v1.GreeterDomainService",
