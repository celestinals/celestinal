...
const (
	GreeterDomainService_SayHello_FullMethodName = "/tickex.greeter.domain.v1.GreeterDomainService/SayHello"
)
...
var GreeterDomainService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "tickex.greeter.domain.v1.GreeterDomainService",
	...
	Metadata: "tickex/greeter/domain/v1/greeter.proto",
}
