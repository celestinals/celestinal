...
var file_ticket_domain_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x52, 0x08, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0x78, 0x0a, 0x13,
	0x54, 0x69, 0x63, 0x6b, 0x65, 0x74, 0x44, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x12, 0x61, 0x0a, 0x08, 0x53, 0x61, 0x79, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x12,
	0x28, 0x2e, 0x74, 0x69, 0x63, 0x6b, 0x65, 0x78, 0x2e, 0x74, 0x69, 0x63, 0x6b, 0x65, 0x74, 0x2e,
	...
	0x65, 0x78, 0x2e, 0x74, 0x69, 0x63, 0x6b, 0x65, 0x74, 0x2e, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e,
	...
	0x74, 0x69, 0x63, 0x6b, 0x65, 0x74, 0x2f, 0x64, 0x6f, 0x6d, 0x61, 0x69, 0x6e, 0x2f, 0x76, 0x31,
...
var file_ticket_domain_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_ticket_domain_proto_goTypes = []any{
	(*SayHelloRequest)(nil),      // 0: tickex.ticket.domain.v1.SayHelloRequest
	(*SayHelloResponse)(nil),     // 1: tickex.ticket.domain.v1.SayHelloResponse
	(*v1.Pages)(nil),             // 2: tickex.types.v1.Pages
	(*v11.SayHelloResponse)(nil), // 3: tickex.ticket.shared.v1.SayHelloResponse
}
var file_ticket_domain_proto_depIdxs = []int32{
	2, // 0: tickex.ticket.domain.v1.SayHelloRequest.page:type_name -> tickex.types.v1.Pages
	3, // 1: tickex.ticket.domain.v1.SayHelloResponse.response:type_name -> tickex.ticket.shared.v1.SayHelloResponse
	0, // 2: tickex.ticket.domain.v1.TicketDomainService.SayHello:input_type -> tickex.ticket.domain.v1.SayHelloRequest
	1, // 3: tickex.ticket.domain.v1.TicketDomainService.SayHello:output_type -> tickex.ticket.domain.v1.SayHelloResponse
