...
func (x *FlagAPIGateway) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*FlagAPIGateway) ProtoMessage() {}

func (x *FlagAPIGateway) ProtoReflect() protoreflect.Message {
	mi := &file_celestinal_v1_flags_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use FlagAPIGateway.ProtoReflect.Descriptor instead.
func (*FlagAPIGateway) Descriptor() ([]byte, []int) {
	return file_celestinal_v1_flags_proto_rawDescGZIP(), []int{1}
}

func (x *FlagAPIGateway) GetTelegram() bool {
	if x != nil {
		return x.Telegram
	}
	return false
...
func (x *FlagAPIGateway) GetSwaggerPath() string {
	if x != nil {
...
func (x *FlagAPIGateway) GetApiSpecsPath() string {
	if x != nil {
...
var file_celestinal_v1_flags_proto_rawDesc = []byte{
	...
	0x6f, 0x64, 0x65, 0x22, 0x75, 0x0a, 0x0e, 0x46, 0x6c, 0x61, 0x67, 0x41, 0x50, 0x49, 0x47, 0x61,
	0x74, 0x65, 0x77, 0x61, 0x79, 0x12, 0x1a, 0x0a, 0x08, 0x74, 0x65, 0x6c, 0x65, 0x67, 0x72, 0x61,
	0x6d, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x74, 0x65, 0x6c, 0x65, 0x67, 0x72, 0x61,
	0x6d, 0x12, 0x21, 0x0a, 0x0c, 0x73, 0x77, 0x61, 0x67, 0x67, 0x65, 0x72, 0x5f, 0x70, 0x61, 0x74,
	...
	0x69, 0x53, 0x70, 0x65, 0x63, 0x73, 0x50, 0x61, 0x74, 0x68, 0x42, 0x47, 0x5a, 0x45, 0x67, 0x69,
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x63, 0x65, 0x6c, 0x65, 0x73, 0x74, 0x69,
	0x6e, 0x61, 0x6c, 0x73, 0x2f, 0x63, 0x65, 0x6c, 0x65, 0x73, 0x74, 0x69, 0x6e, 0x61, 0x6c, 0x2f,
	0x61, 0x70, 0x69, 0x2f, 0x67, 0x65, 0x6e, 0x2f, 0x67, 0x6f, 0x2f, 0x63, 0x65, 0x6c, 0x65, 0x73,
	0x74, 0x69, 0x6e, 0x61, 0x6c, 0x2f, 0x76, 0x31, 0x3b, 0x63, 0x65, 0x6c, 0x65, 0x73, 0x74, 0x69,
...
var file_celestinal_v1_flags_proto_goTypes = []any{
	...
	(*FlagAPIGateway)(nil), // 1: celestinal.v1.FlagAPIGateway
}
